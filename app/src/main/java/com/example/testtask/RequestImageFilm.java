...
public class RequestImageFilm extends Thread{
    ...
    private ImageMovie parseMovie(String JsonString) throws IOException {
        Moshi moshi = new Moshi.Builder().build();
        JsonAdapter<ImageMovie> adapter = moshi.adapter(ImageMovie.class);

        ImageMovie movie = adapter.fromJson(JsonString);
        return movie;
    }
