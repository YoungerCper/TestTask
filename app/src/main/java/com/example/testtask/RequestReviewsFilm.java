...
public class RequestReviewsFilm extends Thread{
    ...
    public void run(){
        ...
        try {
            ReviewsMovie movie = this.parseMovie(JsonString);
    ...
    private ReviewsMovie parseMovie(String JsonString) throws IOException {
        Moshi moshi = new Moshi.Builder().build();
        JsonAdapter<ReviewsMovie> adapter = moshi.adapter(ReviewsMovie.class);

        ReviewsMovie movie = adapter.fromJson(JsonString);
        return movie;
    }
}
